...
func (c *js) Run(ctx context.Context, sourceCode string, testcase model.TestCase) (float32, int64, error) {
	//TODO :: find accuracy of javascript code by running code with test cases
