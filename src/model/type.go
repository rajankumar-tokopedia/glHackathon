...
//func (r *repo) GetLeaders(ctx context.Context, eventId int64, howMany int64) ([]interface{}, error) {
...
func (r *repo) GetEventProblemsByGroupId(ctx context.Context, eventId int64, groupId int64, limit int64) ([]model.Submission, error) {
